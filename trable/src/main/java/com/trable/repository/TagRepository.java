...
//	List<Tag> getTagnamebycount (@Param("MEMBERID") Long memberid);
	...
	@Query(value = "select c.tag_id, c.tagname from post a join post_tag b on a.post_id = b.post_id join tag c on b.tag_id = c.tag_id where a.post_id = :postid", nativeQuery = true)
